...
class CitacaoService implements CitacaoServiceInterface {
  ...
  constructor(citacaoRepository: CitacaoRepositoryInterface, colecaoRepository: ColecaoRepositoryInterface) {
  ...
  async create({  titulo, id_colecao }: CitacaoInterface): Promise<CitacaoEntity> {
    return await this.citacaoRepository.create({ titulo, id_colecao })
  }

  async update(id: number, {  titulo, id_colecao }: CitacaoInterface): Promise<CitacaoEntity>  {
  ...
  async delete(id: number): Promise<void> {
    ...
    return await this.citacaoRepository.delete(id)
  }
}
